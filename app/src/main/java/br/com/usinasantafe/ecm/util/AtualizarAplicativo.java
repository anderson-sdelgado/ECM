...
public class AtualizarAplicativo extends AsyncTask<String ,Integer ,Boolean> {
    ...
    private String descrSistema = "ecm";
    ...
    protected Boolean doInBackground(String... arg0) {
        ...
        try {
            ...
            URL url = new URL("http://www.usinasantafe.com.br/" + descrSistema + "/" + descrSistema + ".apk");
            ...
            File outputFile = new File(file,descrSistema + ".apk");
    ...
    void OpenNewVersion(String location) {
        ...
        intent.setDataAndType(Uri.fromFile(new File(location + "/" + descrSistema + ".apk")),
