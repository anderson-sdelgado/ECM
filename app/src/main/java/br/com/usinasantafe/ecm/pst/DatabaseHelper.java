...
import br.com.usinasantafe.ecm.to.tb.estaticas.TipoFuncCamTO;
...
public class DatabaseHelper extends OrmLiteSqliteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db, ConnectionSource cs) {
		...
		try{
			...
			TableUtils.createTable(cs, NoteiroCanaTO.class);
			TableUtils.createTable(cs, NoteiroVinhacaTO.class);
			TableUtils.createTable(cs, OperadorCarregTO.class);
			TableUtils.createTable(cs, OSTO.class);
			TableUtils.createTable(cs, TipoFuncCamTO.class);
